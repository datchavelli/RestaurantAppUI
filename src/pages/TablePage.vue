    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <th scope="col" v-if="roleCheck == 2">Seat</th>
        </tr>
      </thead>
      <tbody v-if="table.orders.length > 0">
        <tr
        ...
        >
          ...
          <td>{{ orders.takenAt }}</td>
          <td>{{ orders.status }}</td>
          <td>
            <strong>{{ orders.totalAmount }}.00</strong>
          </td>
          <td>{{ orders.waiter }}</td>
          <td>
            <router-link
        ...
        <div slot="body">
          <form>
            ...
            <input
              ...
              type="text"
            />
            <input v-else id="customer-name" class="form-control" type="text" />
